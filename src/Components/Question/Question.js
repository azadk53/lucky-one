...
const Question = () => {
    return (
        <div className='question'>
            ...
            <p>useSate is one kind of hook which is used inside a function. It dose not work inside class. It declares a initial value and a function.We use it for update data dynamically. It returns current value and a function that updates it.</p>
        </div>
    );
};
